...
const BRAND_REGISTERED_FEATURE_CARDS = [IMAGE_GENERATE_CARD, DETAIL_EDIT_CARD];

const formatSyncedAt = (isoDate: string) => {
...
export default function HomePage() {
  ...
  usePrefetchLibraryFolders(isAuthenticated === true);
